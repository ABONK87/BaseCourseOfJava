package baseCourseOfJava.lection6objects.HomeWork1;
...
//    Сделать метод для вывода данных. Прочее на ваше усмотрение.
    ...
    public int compareTime(Time timeObject) {
        if (this.getSecond() > timeObject.getSecond()) {
            return 1;
        }
        else if (this.getSecond() == timeObject.getSecond()) {
            return 0;
        }
        else {
            return -1;
